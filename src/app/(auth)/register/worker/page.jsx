...
export default function WorkerRegisterPage() {
  ...
  const serviceOptions = ['cleaning', 'laundry', 'carwash', 'carrepair'];
  ...
  const handleGoogleSignIn = () => {
    signIn('google', { callbackUrl: '/dashboard?userType=worker' });
  };
    ...
    <div className="container mx-auto px-4 py-8 min-h-screen flex items-center justify-center">
      ...
      >
        <Card className="bg-secondary border-0 text-white">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-center text-primary">Register as a Worker</CardTitle>
          </CardHeader>
          <CardContent>
